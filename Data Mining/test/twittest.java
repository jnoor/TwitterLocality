...
public class Twitter {
	...
	private String twitter_consumer_key = "Rah3elQx9UdjQCfl2CNnBOUs4";
	private String twitter_consumer_secret = "bMI9g4aQJ9CGIa2n4PQyfKTjqnplVaHH6xd7WZW2J0J4MYgjLA";	
	...
	public JSONObject searchTweetsByLocation(String q, String access_token, String access_token_secret, String latitude, String longitude, String radius)
	{
		JSONObject jsonresponse = new JSONObject();
		...
		// this time, I add 3 extra params to the request, "lang", "result_type" and "q".
		String parameter_string = "oauth_consumer_key=" + twitter_consumer_key + "&oauth_nonce=" + oauth_nonce + "&oauth_signature_method=" + oauth_signature_method + 
			"&oauth_timestamp=" + oauth_timestamp + "&oauth_token=" + encode(oauth_token) + "&oauth_version=1.0&q=" + encode(q) + "&geocode=" + latitude + "," + longitude + "," + radius + "&result_type=mixed";	
		System.out.println("parameter_string=" + parameter_string);
		String twitter_endpoint = "https://api.twitter.com/1.1/search/tweets.json";
		String twitter_endpoint_host = "api.twitter.com";
		String twitter_endpoint_path = "/1.1/search/tweets.json";
	...
	public static void main(String[] args) {
		...
		String access_token_secret = "lB58NGGz55YJeeG21HLRhTeZbVRoP9r8a6BF5JlB1YhBp";
		String access_token = "28293717-4hWpQanpcQWVdrvaXmEKpDqnBJtj2laRAt2WCnkFM";
		
		Twitter twitter = new Twitter();
		System.out.println("build done");

		JSONObject coachella = twitter.searchTweetsByLocation("", access_token, access_token_secret, "34.0678340", "-118.450705", "20mi");
		System.out.println("searched");
		System.out.println("Search returned: " + coachella.length());
		
		Iterator itr = coachella.keys();
		//if(!itr.next().equals("twitter_jo")) System.out.println("This search failed...");
		System.out.println(coachella.toString());
		/*else
			try{
				JSONObject j = coachella.getJSONObject("twitter_jo");
				JSONArray statuses = j.getJSONArray("statuses");
				JSONObject search_metadata = j.getJSONObject("search_metadata");
				System.out.println("METADATA: " + search_metadata.toString());
				System.out.println("Got " + statuses.length() + " statuses");
				System.out.println("Printing status 1: ");
